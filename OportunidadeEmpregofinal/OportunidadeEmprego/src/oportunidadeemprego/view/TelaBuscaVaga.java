...
public class TelaBuscaVaga implements ActionListener, ListSelectionListener {
    ...
    public TelaBuscaVaga(JList<String> listaVagasCadastradas) {
    ...
    private void realizarBusca() {
        ...
        DefaultListModel<String> modelJList = (DefaultListModel<String>) listaVagasCadastradas.getModel();
        model.clear();
        ...
        if (!encontrada) {
            JOptionPane.showMessageDialog(janela, "Nenhuma vaga encontrada.", "Busca",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
